...
var projectName = 'lc_dkp/h5' || process.env.npm_package_name;; // 项目名称 package.json name
...
module.exports = {
    build: {
        ...
        index: path.resolve(__dirname, '../../../view/lc_dkp/h5_index.html'), // 输出 index.html 文件路径
        assetsRoot: path.resolve(__dirname, '../../../www/static'), // 资源路径
        assetsSubDirectory: projectName, // 静态资源路径
        assetsPublicPath: '/static/', // cdn 路径
